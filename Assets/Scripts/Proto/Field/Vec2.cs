...
public struct Vec2 : IFlatbufferObject
{
  ...
  public static Offset<field.Vec2> CreateVec2(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f) {
  ...
  public static Offset<field.Vec2> EndVec2(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<field.Vec2>(o);
  }
}
